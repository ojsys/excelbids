...
<div class="grid grid-side content-narrow" style="max-width:900px;">
    ...
    <div class="card-body tight">
      <div class="u-flex u-mb">
        ...
        <div style="min-width:0;">
          ...
          <div class="u-small u-faint"><?= e((string) $user['organisation']) ?></div>
        </div>
      </div>
      <dl class="dl">
        <dt>Email</dt><dd class="u-small"><?= e((string) $user['email']) ?></dd>
        <dt>Last signed in</dt><dd><?= e(fdatetime((string) ($user['last_login_at'] ?? ''))) ?></dd>
      </dl>
      <p class="u-small u-faint u-mt">
        To change the email address on this account, or to give a colleague their own login,
        <?php if (Settings::bool('portal_messaging', true)): ?>
          <a href="<?= e(path('portal/messages')) ?>">message your bid team</a>.
        <?php else: ?>
          email <a href="mailto:<?= e((string) Settings::get('contact_email', '')) ?>"><?= e((string) Settings::get('contact_email', '')) ?></a>.
        <?php endif; ?>
      </p>
    </div>
  </section>
  ...
  <div>
    <section class="card">
      ...
      <form method="post" action="<?= e(path('portal/account')) ?>" data-guard-submit>
        <?= csrf_field() ?>
